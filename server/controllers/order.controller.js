...
import mongoose from "mongoose";
 ...
 export async function CashOnDeliveryOrderController(request,response){
    try {
        ...
        const user = await UserModel.findById(userId).select("role name email")
...
export async function getUserOrderDetailsController(request, response) {
  try {
    console.log("Logged role:", request.role)
...
export async function markOrderDeliveredController(req, res) {
    try {
