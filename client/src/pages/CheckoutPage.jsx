...
const CheckoutPage = () => {
  ...
  const [selectAddress, setSelectAddress] = useState(null) // Changed to null for easier check
  const cartItemsList = useSelector(state => state.cartItem.cart)
  const navigate = useNavigate()

  const handleCashOnDelivery = async () => {
    // Check if there is any address
    if (!addressList.length || selectAddress === null) {
      toast.error('Please add/select an address before placing the order')
      setOpenAddress(true)
      return
    }
